...
export const ProfileView = ({
    ...
    const handleSavePreferences = async () => {
        try {
            const res = await fetch(`${import.meta.env.VITE_API_URL}/api/v1/users/me/settings`, {
                method: "PUT",
    ...
    const handleSavePassword = async (e) => {
        ...
        try {
            const res = await fetch(`${import.meta.env.VITE_API_URL}/api/v1/users/me/password`, {
                method: "PUT",
                headers: { "Authorization": `Bearer ${currentToken}`, "Content-Type": "application/json" },

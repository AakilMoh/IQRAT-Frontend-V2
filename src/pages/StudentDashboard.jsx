      ...
      const fetchCoreData = async () => {
          ...
          try {
              ...
              const [crsRes, histRes, statsRes, profRes, notifRes] = await Promise.all([
                  fetch(`${import.meta.env.VITE_API_URL}/api/v1/users/me/courses`, { headers }),
                  fetch(`${import.meta.env.VITE_API_URL}/api/v1/users/me/attendance`, { headers }),
                  fetch(`${import.meta.env.VITE_API_URL}/api/v1/users/me/dashboard-stats`, { headers }),
                  fetch(`${import.meta.env.VITE_API_URL}/api/v1/users/me/profile`, { headers }),
                  fetch(`${import.meta.env.VITE_API_URL}/api/v1/users/me/notifications`, { headers })
              ]);
      ...
      const fetchHeavyData = async () => {
          ...
          try {
              ...
              const [gradesRes, aiRes] = await Promise.all([
                  fetch(`${import.meta.env.VITE_API_URL}/api/v1/users/me/grades`, { headers }),
                  fetch(`${import.meta.env.VITE_API_URL}/api/v1/users/me/predictions`, { headers })
              ]);
  ...
  useEffect(() => {
      const fetchMyTimetable = async () => {
          ...
          try {
              ...
              const res = await fetch(`${import.meta.env.VITE_API_URL}/api/v1/users/me/timetable`, {
